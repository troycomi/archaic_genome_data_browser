...
Revision ID: db5dbf1107ee
Revises: 
Create Date: 2018-10-10 21:32:27.538688
...
def upgrade():
    ...
    sa.Column('archaic_genome_call', sa.String(length=128), nullable=False),
    sa.Column('haplotype', sa.Integer(), nullable=False),
    sa.Column('bed_file', sa.String(length=512), nullable=False),
    sa.Column('total_bps', sa.Integer(), nullable=False),
    sa.Column('total_haplotypes', sa.Integer(), nullable=False),
    sa.ForeignKeyConstraint(['archaic_analysis_run_id'], ['archaic_analysis_run.id'], ),
    sa.ForeignKeyConstraint(['sample_id'], ['sample.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('idx_sample_run_genome_haplotype', 'archaic_genome_data', ['sample_id', 'archaic_analysis_run_id', 'archaic_genome_call', 'haplotype'], unique=True)
    op.create_index(op.f('ix_archaic_genome_data_archaic_genome_call'), 'archaic_genome_data', ['archaic_genome_call'], unique=False)
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.drop_index(op.f('ix_archaic_genome_data_archaic_genome_call'), table_name='archaic_genome_data')
    op.drop_index('idx_sample_run_genome_haplotype', table_name='archaic_genome_data')
